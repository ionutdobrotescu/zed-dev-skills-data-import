...
class AntelopeSearchConfig extends AbstractBundleConfig
{
     ...
     * @var string
     */
    public const string ANTELOPE_PUBLISH_SEARCH_QUEUE = 'publish.search.antelope';
     ...
     * @var string
     */
    public const string ANTELOPE_SYNC_SEARCH_QUEUE = 'sync.search.antelope';
     ...
     * @var string
     */
    public const string ENTITY_PYZ_ANTELOPE_CREATE = 'Entity.pyz_antelope.create';
     ...
     * @var string
     */
    public const string ENTITY_PYZ_ANTELOPE_UPDATE = 'Entity.pyz_antelope.update';
     ...
     * @var string
     */
    public const string ENTITY_PYZ_ANTELOPE_DELETE = 'Entity.pyz_antelope.delete';
     ...
     * @var string
     */
    public const string ANTELOPE_PUBLISH = 'AntelopeSearch.antelope.publish';
